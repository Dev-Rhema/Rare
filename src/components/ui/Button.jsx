...
const VARIANTS = {
  ...
  secondary: 'bg-brand-yellow text-ink hover:bg-brand-yellow-light',
...
export default function Button({ variant = 'primary', size = 'md', to, type = 'button', className, children, ...props }) {
  const classes = cn(
